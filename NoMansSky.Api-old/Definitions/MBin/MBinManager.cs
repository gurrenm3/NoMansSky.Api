...
namespace NoMansSky.Api
{
    ...
    internal class MBinManager : IMBinManager
    {
        ...
        public IMBin GetMBin(string mbinName, bool useFullName = false)
        {
            ...
            {
                ConsoleUtils.WriteError("Failed to get mbin because none have been loaded yet." +
        ...
        public Type GetMBinTypeFromName(string mbinName)
        {
            ...
            {
                ConsoleUtils.WriteError("Can't get mbin type because provided mbin name was invalid");
                return null!;
            }                
