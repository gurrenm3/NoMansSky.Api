...
{
    /// <summary>
    /// Extension methods for <see cref="IFreighterTraitFile"/>.
    /// </summary>
    public static class IFreighterTraitFileExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static GcFrigateTraitTable GetValue(this IFreighterTraitFile instance)
        {
            return instance.MBin.GetValue<GcFrigateTraitTable>();
        }
        ...
        public static void Modify(this IFreighterTraitFile instance, Action<GcFrigateTraitTable> modifyAction)
        {
        ...
        /// <param name="modifyAction"></param>
        /// <returns></returns>
        public static async Task ModifyAsync(this IFreighterTraitFile instance, Action<GcFrigateTraitTable> modifyAction)
        {
