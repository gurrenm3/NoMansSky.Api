...
{
    /// <summary>
    /// Extension methods for <see cref="IPurchaseableSpecialsFile"/>.
    /// </summary>
    public static class IPurchaseableSpecialsFileExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static GcPurchaseableSpecials GetValue(this IPurchaseableSpecialsFile instance)
        {
            return instance.MBin.GetValue<GcPurchaseableSpecials>();
        }
        ...
        public static void Modify(this IPurchaseableSpecialsFile instance, Action<GcPurchaseableSpecials> modifyAction)
        {
        ...
        /// <param name="modifyAction"></param>
        /// <returns></returns>
        public static async Task ModifyAsync(this IPurchaseableSpecialsFile instance, Action<GcPurchaseableSpecials> modifyAction)
        {
