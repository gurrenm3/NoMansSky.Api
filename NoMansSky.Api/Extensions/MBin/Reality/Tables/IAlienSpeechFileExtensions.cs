...
{
    /// <summary>
    /// Extension methods for <see cref="IAlienSpeechFile"/>.
    /// </summary>
    public static class IAlienSpeechFileExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static GcAlienSpeechTable GetValue(this IAlienSpeechFile instance)
        {
            return instance.MBin.GetValue<GcAlienSpeechTable>();
        }
        ...
        public static void Modify(this IAlienSpeechFile instance, Action<GcAlienSpeechTable> modifyAction)
        {
        ...
        /// <param name="modifyAction"></param>
        /// <returns></returns>
        public static async Task ModifyAsync(this IAlienSpeechFile instance, Action<GcAlienSpeechTable> modifyAction)
        {
