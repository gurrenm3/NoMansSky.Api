...
namespace NoMansSky.Api
{
    ...
    public static class IFreighterDungeonsFileExtensions
    {
        ...
        /// <param name="instance"></param>
        /// <returns></returns>
        public static async Task<GcFreighterDungeonsTable> GetValueAsync(this IFreighterDungeonsFile instance)
        {
            return await instance.MBin.GetValueAsync<GcFreighterDungeonsTable>();
        }
