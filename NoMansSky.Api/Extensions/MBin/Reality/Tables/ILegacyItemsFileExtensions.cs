...
{
    /// <summary>
    /// Extension methods for <see cref="ILegacyItemsFile"/>.
    /// </summary>
    public static class ILegacyItemsFileExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static GcLegacyItemTable GetValue(this ILegacyItemsFile instance)
        {
            return instance.MBin.GetValue<GcLegacyItemTable>();
        }
        ...
        public static void Modify(this ILegacyItemsFile instance, Action<GcLegacyItemTable> modifyAction)
        {
        ...
        /// <param name="modifyAction"></param>
        /// <returns></returns>
        public static async Task ModifyAsync(this ILegacyItemsFile instance, Action<GcLegacyItemTable> modifyAction)
        {
