...
{
    /// <summary>
    /// Extension methods for <see cref="IProductsFile"/>.
    /// </summary>
    public static class IProductsFileExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static GcProductTable GetValue(this IProductsFile instance)
        {
            return instance.MBin.GetValue<GcProductTable>();
        }
        ...
        public static void Modify(this IProductsFile instance, Action<GcProductTable> modifyAction)
        {
        ...
        /// <param name="modifyAction"></param>
        /// <returns></returns>
        public static async Task ModifyAsync(this IProductsFile instance, Action<GcProductTable> modifyAction)
        {
