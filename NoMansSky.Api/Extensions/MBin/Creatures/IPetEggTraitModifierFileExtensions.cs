...
namespace NoMansSky.Api
{
    ...
    public static class IPetEggTraitModifierFileExtensions
    {
        ...
        /// <param name="instance"></param>
        /// <returns></returns>
        public static async Task<GcPetEggTraitModifierOverrideTable> GetValueAsync(this IPetEggTraitModifierFile instance)
        {
            return await instance.MBin.GetValueAsync<GcPetEggTraitModifierOverrideTable>();
        }
