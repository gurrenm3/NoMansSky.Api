...
{
    /// <summary>
    /// Extension methods for <see cref="ICreatureAudioFile"/>.
    /// </summary>
    public static class ICreatureAudioFileExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static GcCreatureAudioTable GetValue(this ICreatureAudioFile instance)
        {
            return instance.MBin.GetValue<GcCreatureAudioTable>();
        }
        ...
        public static void Modify(this ICreatureAudioFile instance, Action<GcCreatureAudioTable> modifyAction)
        {
        ...
        /// <param name="modifyAction"></param>
        /// <returns></returns>
        public static async Task ModifyAsync(this ICreatureAudioFile instance, Action<GcCreatureAudioTable> modifyAction)
        {
