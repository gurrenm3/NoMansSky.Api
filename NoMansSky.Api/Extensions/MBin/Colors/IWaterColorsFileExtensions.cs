...
namespace NoMansSky.Api
{
    ...
    public static class IWaterColorsFileExtensions
    {
        ...
        /// <param name="instance"></param>
        /// <returns></returns>
        public static async Task<GcWaterColourSettingList> GetValueAsync(this IWaterColorsFile instance)
        {
            return await instance.MBin.GetValueAsync<GcWaterColourSettingList>();
        }
