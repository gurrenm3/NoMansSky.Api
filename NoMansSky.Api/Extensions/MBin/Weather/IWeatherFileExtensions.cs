...
{
    /// <summary>
    /// Extension methods for <see cref="IWeatherFile"/>.
    /// </summary>
    public static class IWeatherFileExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static GcWeatherProperties GetValue(this IWeatherFile instance)
        {
            return instance.MBin.GetValue<GcWeatherProperties>();
        }
        ...
        public static void Modify(this IWeatherFile instance, Action<GcWeatherProperties> modifyAction)
        {
        ...
        /// <param name="modifyAction"></param>
        /// <returns></returns>
        public static async Task ModifyAsync(this IWeatherFile instance, Action<GcWeatherProperties> modifyAction)
        {
