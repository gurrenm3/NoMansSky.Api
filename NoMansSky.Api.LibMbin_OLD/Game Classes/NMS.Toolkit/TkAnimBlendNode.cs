...
public unsafe class TkAnimBlendNode : NMSTemplate
{
	...
	public NMSTemplate BlendLeft
	{
		get => GetValue<NMSTemplate>();
		set => TrySetValue<NMSTemplate>(value);
	}

	public NMSTemplate BlendRight
	{
		get => GetValue<NMSTemplate>();
		set => TrySetValue<NMSTemplate>(value);
	}

	public TkAnimBlendNode(long address) : base(address)
	{
